  ...
  \cventry
    ...
    {Sept. 2016 - PRESENT} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Implement an internal API portal as the main source of truth by sharing the api contract, uml diagram, api logs, etc...}
        ...
        \item {Deployed a centralized monitoring environment(AppMetrics, Grafana, prometheus) which gather system metrics.}
  ...
  \cventry
    ...
    {Aug. 2015 - Sept. 2016} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Create a  Penetration tests step on the continuous integration pipeline}
